...
import { ClinicListCityLocalityRoutingModule } from "./hospital-list-routing.module"; 
...
@NgModule({
  ...
  imports: [
    CommonModule,
    ClinicListCityLocalityRoutingModule,
...
export class ClinicListCityLocalityModule {}
