...
import { SelectEstablishmentComponent } from "../../../hospitals/select-establishment/select-establishment.component";
...
export class CalendarViewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const speciality =this.current_speciality= params.get('speciality');
