...
@Component({
  selector: 'nectar-clinicslistings',
  standalone: false,
  templateUrl: './clinicslistings.component.html',
  styleUrls: ['./clinicslistings.component.scss']
})
export class ClinicslistingsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    searchDoctors(obj: any = {}, scroll: boolean = false) {
      ...
      // On first load, transfer cache returns initial render data synchronously, so no flash.
      if (this.apiHit) {
        this.isLoading = true;
      }
