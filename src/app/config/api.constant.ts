...
export const API_ENDPOINTS = {
  ...
  patient: {
    ...
    searchAutocomplete: `${environment.baseUrl}v1/patient/homepage/autocomplete`,
    searchDidYouMean: `${environment.baseUrl}v1/patient/homepage/did-you-mean`,
    searchRelated: `${environment.baseUrl}v1/patient/homepage/related`,
    searchFacets: `${environment.baseUrl}v1/patient/homepage/facets`,
    getAllHospitals: `${environment.baseUrl}v1/hospital/find-hospital-list`,
    getAllHospitals2: `${environment.baseUrl}v1/hospital/find-hospital-list2`,
    findhospitallistbylocality: `${environment.baseUrl}v1/hospital/find-hospital-list-by-locality`,
    findcliniclistbylocality: `${environment.baseUrl}v1/hospital/find-clinic-list-by-locality`,
    findadditionaLocality: `${environment.baseUrl}v1/hospital/localities`,
    getAllclinics: `${environment.baseUrl}v1/hospital/find-clinics-list`,
    getcity: `${environment.baseUrl}v1/hospital`,
    getDoctorsUnderHospital: `${environment.baseUrl}v1/hospital/find-doctor-list`,
    getDoctorsUnderHospital_2: `${environment.baseUrl}v1/hospital/find-doctor-list_2`,
    getDoctorsUnderHospital_3: `${environment.baseUrl}v1/hospital/find-doctor-list_3`,
    ...
    cityspecialization: `${environment.baseUrl}v1/patient/cityspecialization`,
    localityspecialization: `${environment.baseUrl}v1/patient/localityspecialization`,
    NearHospital: `${environment.baseUrl}v1/patient/nearhospital`,
    localitywisedoctor: `${environment.baseUrl}v1/patient/getlocalitiesbycity`,
    getCitiesofDoctors: `${environment.baseUrl}v1/patient/getcitiesofdoctors`,
    getCurrentCitySpecialization: `${environment.baseUrl}v1/patient/getcurrentcityspecialization`,
    seoLinks: `${environment.baseUrl}v1/patient/seo-links`,
    hospitalSeoLinks: `${environment.baseUrl}v1/patient/hospital-seo-links`,
    clinicSeoLinks: `${environment.baseUrl}v1/patient/clinic-seo-links`,
    searchCities: `${environment.baseUrl}v1/patient/homepage/cities`,
    searchNearMe: `${environment.baseUrl}v1/patient/search-near-me`,
    geoCity: `${environment.baseUrl}v1/city/geo-city`,
    resolveCity: `${environment.baseUrl}v1/city/resolve`,
    cityBySlug: `${environment.baseUrl}v1/city/by-slug`,

    // Treatment SEO Engine
    treatmentBySlug: `${environment.baseUrl}v1/surgery/treatment`,
    treatmentDoctors: `${environment.baseUrl}v1/surgery/treatment`,
  ...
  hospital: {
    ...
    NearHospital: `${environment.baseUrl}v1/hospital/nearhospital`,
  ...
  MASTER: {
    ...
    social: `${environment.baseUrl}v1/master/social-media`,
    getservices:`${environment.baseUrl}v1/master/getspec_services`,
  },
  COMMON: {
